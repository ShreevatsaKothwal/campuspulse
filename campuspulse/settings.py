"""
Django settings for campuspulse project.
...
# SECRET_KEY = 'django-insecure-ah^eb90^%j2b!%le=rjk7g-z5fb2n12ubcbts301wyhff01cjz'
...
WSGI_APPLICATION = 'campuspulse.wsgi.application'
